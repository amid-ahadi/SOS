                 ...
                 <div class="box-body">
						...
						<div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">
									<input type="text" name="start_date" id="start_date" value="<?php echo set_value('start_date') ?>" class="form-control" autocomplete="off"> </div>
                            </div>
                        </div>
						...
						<div class="form-group">
                        	<div class="row">
								...
								<div class="col-md-4">
									<input type="text" name="hearing_date" id="hearing_date" value="<?php echo set_value('hearing_date') ?>" class="form-control" autocomplete="off"> </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    // For "Court Date" (تاریخ دادگاه)
    if (document.getElementById('hearing_date')) {
        kamaDatepicker('hearing_date', {
            buttonsColor: "blue",
            forceFarsiDigits: true,
            markToday: true,
            gotoToday: true,
    ...
    // You already had this for client's DOB, ensuring it's still here
    if (document.getElementById('dob_modal')) {
        kamaDatepicker('dob_modal', {
            buttonsColor: "blue",
            forceFarsiDigits: true,
            markToday: true,
            gotoToday: true,
