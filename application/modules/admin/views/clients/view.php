                    ...
                    <div class="box-body">
						...
						<div class="form-group">
						    ...
						    <div class="form-group">
                              <div class="row">
                                <div class="col-md-2">
                                    <label for="father" style="clear:both;"><?php echo lang('father')?></label>
								</div>	
								<div class="col-md-4">	
									<?php echo $clients->father?>
                                </div>
                            </div>
                        </div>
						    <div class="form-group">
