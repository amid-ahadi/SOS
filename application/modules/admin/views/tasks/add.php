...
<?php  } ?>
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                </div><?php echo form_open_multipart('admin/tasks/add/'); ?>
                    <div class="box-body">
			 			 ...
			 			 <div class="form-group">
                               <div class="row">
                                 <div class="col-md-6">
									...
									<input type="text" name="due_date" id="jalali-datepicker-due" value="<?php echo set_value('due_date')?>" class="form-control" autocomplete="off">
...
<script src="<?php echo base_url()?>/assets/js/plugins/bootstrap-slider/bootstrap-slider.js" type="text/javascript"></script>
 ...
 $(document).ready(function(){
    ...
    //  KamaDatepicker  due_date
    kamaDatepicker('jalali-datepicker-due', {
        format: 'YYYY-MM-DD', 
    });
});
 </script>