...
<?php  } ?>
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                </div><?php echo form_open_multipart('admin/tasks/edit/'.$id.'?'.$my_tasks); ?>
                    <div class="box-body">
			 			 ...
			 			 <div class="form-group">
                               <div class="row">
                                 <div class="col-md-6">
									...
									<input type="text" name="due_date" id="jalali-datepicker-due-edit" value="<?php echo $task->due_date?>" class="form-control" autocomplete="off">
						...
						<?php 
					$CI = &get_instance(); // Changed to get_instance() as $CI was undefined initially
						if($fields){
					...
					?>	<div class="form-group">
							...
							<?php	
										foreach($values as $key=>$val) {
											$sel='';
											if(isset($result->reply) && $val==$result->reply) $sel = "selected='selected'"; // Added isset check
...
<script src="<?php echo base_url()?>/assets/js/plugins/bootstrap-slider/bootstrap-slider.js" type="text/javascript"></script>
 ...
 $(document).ready(function(){
    ...
    //  KamaDatepicker 
    kamaDatepicker('jalali-datepicker-due-edit', {
        format: 'YYYY-MM-DD', 
    });
});
 </script>